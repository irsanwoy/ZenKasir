...
export function Sheet({ isOpen, onClose, title, children, className }: SheetProps) {
  return (
    <>
      ...
      <div 
        className={cn(
          "fixed inset-x-0 bottom-0 z-50 lg:static lg:block flex flex-col bg-background border-t lg:border-t-0 lg:border-l lg:rounded-none rounded-t-xl shadow-lg lg:shadow-none transition-transform duration-300 ease-in-out lg:translate-y-0 h-[85vh] lg:h-full lg:w-full",
